...
<ul class="pagination">
<c:if test="${page.prev}">
  <li class="page-item"><a href="/pagenation/board/listPageSearch?num=${page.startPageNum -1}${page.searchTypeKeyword}" class="page-link">[이전]</a></li>
</c:if>
<c:forEach begin='${page.startPageNum}' end="${page.endPageNum}" var="num">
	<c:if test="${select != num }">
		<li class="page-item"><a href="/pagenation/board/listPageSearch?num=${num}${page.searchTypeKeyword}" class="page-link">${num}</a></li>
	</c:if>
	<c:if test="${select == num }">
	<li class="page-item"><a href="/pagenation/board/listPageSearch?num=${num}${page.searchTypeKeyword}" class="page-link"><b class="fw-bold">${num}</b></a></li>
	</c:if>
</c:forEach>
<c:if test="${page.next}">
<li class="page-item"><a href="/pagenation/board/listPageSearch?num=${page.endPageNum + 1 }${page.searchTypeKeyword}" class="page-link">[다음]</a></li>
</c:if>
